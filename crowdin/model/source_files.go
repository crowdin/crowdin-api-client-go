...
// BranchGetResponse describes a response with a single branch.
type BranchGetResponse struct {
	Data *Branch `json:"data"`
}

// BranchListResponse describes a response with a list of branches.
type BranchListResponse struct {
	Data []*BranchGetResponse `json:"data"`
}
...
func (o *BranchListOptions) Values() url.Values {
...
// BranchAddRequest defines the structure of a request to create a new branch.
type BranchAddRequest struct {
	// Branch name.
...
func (r *BranchAddRequest) Validate() error {
	if r.Name == "" {
