...
type (
	...
	Project struct {
		...
		TranslateDuplicates             int64                        `json:"translateDuplicates,omitempty"`
		TagsDetection                   int64                        `json:"tagsDetection,omitempty"`
		...
		DefaultTMID                     int64                        `json:"defaultTmId,omitempty"`
		DefaultGlossaryID               int64                        `json:"defaultGlossaryId,omitempty"`
		AssignedTMs                     map[int64]map[string]int64   `json:"assignedTms,omitempty"`
		AssignedGlossaries              []int64                      `json:"assignedGlossaries,omitempty"`
	...
	ProjectTMPenalties struct {
		AutoSubstitution int64 `json:"autoSubstitution,omitempty"`
		TMPriority       struct {
			Priority int64 `json:"priority,omitempty"`
			Penalty  int64 `json:"penalty,omitempty"`
		} `json:"tmPriority,omitempty"`
		MultipleTranslations int64 `json:"multipleTranslations,omitempty"`
	...
	ProjectMTs struct {
		MTID int64 `json:"mtId,omitempty"`
...
type ProjectsListOptions struct {
	...
	HasManagerAccess int64 `json:"hasManagerAccess,omitempty"`
	// Set type to 0 to get all file based projects. Enum: 0, 1.
	Type int64 `json:"type,omitempty"`
}

func (p *ProjectsListOptions) Values() url.Values {
	v := p.ListOptions.Values()
	if p.UserID > 0 {
		v.Add("userId", fmt.Sprintf("%d", p.UserID))
	}
	if p.HasManagerAccess > 0 {
...
type ProjectsAddRequest struct {
	...
	// prevAndNextSegment - search by previos and next segment.
	TMContextType  string                `json:"tmContextType,omitempty"`
	TMPreTranslate ProjectTMPreTranslate `json:"tmPreTranslate,omitempty"`
	MTPreTranslate ProjectMTPreTranslate `json:"mtPreTranslate,omitempty"`
...
type (
	...
	PropertyFileFormatSettings struct {
		...
		EscapeQuotes int64 `json:"escapeQuotes,omitempty"`
		// Enum: 0, 1. Default: 1.
		...
		EscapeSpecialCharacters int64 `json:"escapeSpecialCharacters,omitempty"`
	}
	...
	JavaScriptFileFormatSettings struct {
		...
		ExportQuotes int64 `json:"exportQuotes,omitempty"`
	}
...
type DownloadCustomSegmentations struct {
	URL      string `json:"url"`
